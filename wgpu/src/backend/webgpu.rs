...
fn map_wgt_limits(limits: webgpu_sys::GpuSupportedLimits) -> wgt::Limits {
    wgt::Limits {
        ...
        max_subpass_color_attachments: wgt::Limits::default().max_subpass_color_attachments,
        max_subpasses: wgt::Limits::default().max_subpasses,
        max_input_attachments: wgt::Limits::default().max_input_attachments,
        estimated_tile_memory_bytes: wgt::Limits::default().estimated_tile_memory_bytes,
